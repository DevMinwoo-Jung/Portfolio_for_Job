export const skills = {
  javascript: { imgSrc: "imgs/icon/javascript.png", skillName: "JavaScript", progressBar: 70 },
  typescript: { imgSrc: "imgs/icon/typescript.png", skillName: "typescript", progressBar: 70},
  html: { imgSrc:"imgs/icon/html.png",skillName:"html", progressBar: 70},
  css: { imgSrc:"imgs/icon/css.png",skillName:"css", progressBar: 70},
  react: { imgSrc:"imgs/icon/react.png",skillName:"react",  progressBar: 70},
  styledComponents: { imgSrc:"imgs/icon/styled-components.png",skillName:"styled-components", progressBar: 70},
  reactRouter: { imgSrc:"imgs/icon/react-router.png",skillName:"react-router", progressBar: 70},
  firebase: { imgSrc:"imgs/icon/firebase.png",skillName:"firebase", progressBar: 70},
  bootstrap: { imgSrc:"imgs/icon/bootstrap.png",skillName:"bootstrap", progressBar: 70},
  tailwind: { imgSrc:"imgs/icon/tailwind.png",skillName:"tailwind", progressBar: 70},
  redux: { imgSrc:"imgs/icon/redux.png",skillName:"redux", progressBar: 70},
  github: { imgSrc:"imgs/icon/github.png",skillName:"github", progressBar: 70},
  sass: { imgSrc:"imgs/icon/sass.png",skillName:"sass", progressBar: 70},
};
